...
public:
    ...
    int first_line;
    int first_column;
    const char *first_file;  /* fname referenced by first line/column */
    long int first_order;    /* relative order in which it is read by lexcial analyser */
    int last_line;
    int last_column;
    const char *last_file;  /* fname referenced by last line/column */
     ...
     */
    /*** Data type analysis ***/
    /* All possible data types the expression/literal/etc. may take. Filled in stage3 by fill_candidate_datatypes_c class */
...
public:
    ...
    symbol_c(
        int first_line = 0,
        int first_colum = 0,
        const char *first_fname = NULL /* fname */,
        long int first_order =0, /* order in which it is read by lexcial analyser */
        int last_line = 0,
        int last_colum = 0,
        const char *last_fname = NULL /* fname */,
        long int last_order = 0  /* order in which it is read by lexcial analyser */
    );
...
class class_name_c:	public list_c {\
  ...
  public:\
    class_name_c(\
                 int first_line = 0,\
				 int frist_colum = 0,\
				 const char *first_fname = NULL,\
				 long int first_order=0,\
                 int last_line = 0,\
				 int last_colum = 0,\
				 const char *last_fname = NULL,\
				 long int last_order=0);\
