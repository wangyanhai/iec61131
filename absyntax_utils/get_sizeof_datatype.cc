...
void *get_sizeof_datatype_c::visit(bool_type_name_c *symbol)
{
    return _encode_int(1);
}
void *get_sizeof_datatype_c::visit(sint_type_name_c *symbol)
{
    return _encode_int(8);
}
void *get_sizeof_datatype_c::visit(int_type_name_c *symbol)
{
    return _encode_int(16);
}
void *get_sizeof_datatype_c::visit(dint_type_name_c *symbol)
{
    return _encode_int(32);
}
void *get_sizeof_datatype_c::visit(lint_type_name_c *symbol)
{
    return _encode_int(64);
}
void *get_sizeof_datatype_c::visit(usint_type_name_c *symbol)
{
    return _encode_int(8);
}
void *get_sizeof_datatype_c::visit(uint_type_name_c *symbol)
{
    return _encode_int(16);
}
void *get_sizeof_datatype_c::visit(udint_type_name_c *symbol)
{
    return _encode_int(32);
}
void *get_sizeof_datatype_c::visit(ulint_type_name_c *symbol)
{
    return _encode_int(64);
}
void *get_sizeof_datatype_c::visit(real_type_name_c *symbol)
{
    return _encode_int(32);
}
void *get_sizeof_datatype_c::visit(lreal_type_name_c *symbol)
{
    return _encode_int(64);
}
...
void *get_sizeof_datatype_c::visit(byte_type_name_c *symbol)
{
    return _encode_int(8);
}
void *get_sizeof_datatype_c::visit(word_type_name_c *symbol)
{
    return _encode_int(16);
}
void *get_sizeof_datatype_c::visit(dword_type_name_c *symbol)
{
    return _encode_int(32);
}
void *get_sizeof_datatype_c::visit(lword_type_name_c *symbol)
{
    return _encode_int(64);
}
...
void *get_sizeof_datatype_c::visit(safebool_type_name_c *symbol)
{
    return _encode_int(1);
}
void *get_sizeof_datatype_c::visit(safesint_type_name_c *symbol)
{
    return _encode_int(8);
}
void *get_sizeof_datatype_c::visit(safeint_type_name_c *symbol)
{
    return _encode_int(16);
}
void *get_sizeof_datatype_c::visit(safedint_type_name_c *symbol)
{
    return _encode_int(32);
}
void *get_sizeof_datatype_c::visit(safelint_type_name_c *symbol)
{
    return _encode_int(64);
}
void *get_sizeof_datatype_c::visit(safeusint_type_name_c *symbol)
{
    return _encode_int(8);
}
void *get_sizeof_datatype_c::visit(safeuint_type_name_c *symbol)
{
    return _encode_int(16);
}
void *get_sizeof_datatype_c::visit(safeudint_type_name_c *symbol)
{
    return _encode_int(32);
}
void *get_sizeof_datatype_c::visit(safeulint_type_name_c *symbol)
{
    return _encode_int(64);
}
void *get_sizeof_datatype_c::visit(safereal_type_name_c *symbol)
{
    return _encode_int(32);
}
void *get_sizeof_datatype_c::visit(safelreal_type_name_c *symbol)
{
    return _encode_int(64);
}
...
void *get_sizeof_datatype_c::visit(safebyte_type_name_c *symbol)
{
    return _encode_int(8);
}
void *get_sizeof_datatype_c::visit(safeword_type_name_c *symbol)
{
    return _encode_int(16);
}
void *get_sizeof_datatype_c::visit(safedword_type_name_c *symbol)
{
    return _encode_int(32);
}
void *get_sizeof_datatype_c::visit(safelword_type_name_c *symbol)
{
    return _encode_int(64);
}
