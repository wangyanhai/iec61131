 ...
 */
list_c *decompose_var_instance_name_c::get_current_arraysubs_list(void)
{
    return current_array_subscript_list;
}
...
void *decompose_var_instance_name_c::visit(identifier_c *symbol)
{
    return (void *)symbol;
}
...
/* B 1.4 - Variables */
/*********************/
void *decompose_var_instance_name_c::visit(symbolic_variable_c *symbol)
{
    return (void *)(symbol->var_name);
}

/********************************************/
/* B.1.4.1   Directly Represented Variables */
/********************************************/
void *decompose_var_instance_name_c::visit(direct_variable_c *symbol)
{
    return (void *)symbol;
}
...
/* B 2.2 - Operators */
/********************************/
void *decompose_var_instance_name_c::visit(LD_operator_c *symbol)
{
    return (void *)&LD_operator_name;
}
void *decompose_var_instance_name_c::visit(S_operator_c *symbol)
{
    return (void *)&S_operator_name;
}
void *decompose_var_instance_name_c::visit(R_operator_c *symbol)
{
    return (void *)&R_operator_name;
}
void *decompose_var_instance_name_c::visit(S1_operator_c *symbol)
{
    return (void *)&S1_operator_name;
}
void *decompose_var_instance_name_c::visit(R1_operator_c *symbol)
{
    return (void *)&R1_operator_name;
}
void *decompose_var_instance_name_c::visit(CLK_operator_c *symbol)
{
    return (void *)&CLK_operator_name;
}
void *decompose_var_instance_name_c::visit(CU_operator_c *symbol)
{
    return (void *)&CU_operator_name;
}
void *decompose_var_instance_name_c::visit(CD_operator_c *symbol)
{
    return (void *)&CD_operator_name;
}
void *decompose_var_instance_name_c::visit(PV_operator_c *symbol)
{
    return (void *)&PV_operator_name;
}
void *decompose_var_instance_name_c::visit(IN_operator_c *symbol)
{
    return (void *)&IN_operator_name;
}
void *decompose_var_instance_name_c::visit(PT_operator_c *symbol)
{
    return (void *)&PT_operator_name;
}
