...
void *search_varfb_instance_type_c::visit(structure_element_initialization_list_c *symbol)
{
    ERROR;    /* should never get called... */
    return NULL;
}
/*  structure_element_name ASSIGN value */
void *search_varfb_instance_type_c::visit(structure_element_initialization_c *symbol)
{
    ERROR;    /* should never get called... */
    return NULL;
}
