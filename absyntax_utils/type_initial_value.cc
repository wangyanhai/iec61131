...
{
    return handle_type_name(symbol);   /* should never occur */
}
void *type_initial_value_c::visit(         poutype_identifier_c *symbol)
{
    return handle_type_name(symbol);   /* in practice it might never get called, as FB, Functions and Programs do not have initial value  */
}
