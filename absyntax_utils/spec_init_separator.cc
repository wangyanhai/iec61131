...
void *spec_init_sperator_c::visit(subrange_specification_c *symbol)
{
    ...
    {
    case search_spec:
        return symbol->integer_type_name;
    case search_init:
...
void *spec_init_sperator_c::visit(array_spec_init_c *symbol)
{
    ...
    {
    case search_spec:
        return symbol->array_specification;
    case search_init:
        return symbol->array_initialization;
    }
    return NULL;
}
...
void *spec_init_sperator_c::visit(enumerated_spec_init_c *symbol)
{
    ...
    {
    case search_spec:
        return symbol->enumerated_specification;
    case search_init:
        return symbol->enumerated_value;
    }
    ERROR; /* should never occur */
    return NULL;
}
...
void *spec_init_sperator_c::visit(initialized_structure_c *symbol)
{
    ...
    case search_init:
        return symbol->structure_initialization;
    }
    ERROR; /* should never occur */
    return NULL;
}
...
void *spec_init_sperator_c::visit(fb_spec_init_c *symbol)
{
    ...
    {
    case search_spec:
        return symbol->function_block_type_name;
    case search_init:
        return symbol->structure_initialization;
    }
    ERROR; /* should never occur */
...
void *spec_init_sperator_c::visit(ref_spec_init_c *symbol)
{
    ...
    {
    case search_spec:
        return symbol->ref_spec;
    case search_init:
        return symbol->ref_initialization;
    }
    ERROR; /* should never occur */
    return NULL;
...
void *spec_init_sperator_c::visit(single_byte_string_spec_c *symbol)
{
    ...
    {
    case search_spec:
        return symbol->string_spec;
    case search_init:
        return symbol->single_byte_character_string;
    }
    ERROR; /* should never occur */
    return NULL;
}
...
void *spec_init_sperator_c::visit(double_byte_string_spec_c *symbol)
{
    ...
    case search_spec:
        return symbol->string_spec;
    case search_init:
        return symbol->double_byte_character_string;
    }
    ERROR; /* should never occur */
    return NULL;
}
