...
std::string &create_enumtype_conversion_functions_c::get_declaration(symbol_c *symbol)
{
    if (NULL == singleton) 
	{
		singleton = new create_enumtype_conversion_functions_c(NULL);
	}
    if (NULL == singleton)
	{
...
void *create_enumtype_conversion_functions_c::visit(poutype_identifier_c *symbol)
{
    ERROR;
    return NULL;
}
void *create_enumtype_conversion_functions_c::visit(derived_datatype_identifier_c *symbol)
{
    ERROR;
    return NULL;
}
